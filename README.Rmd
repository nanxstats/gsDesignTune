...
sequential designs created by gsDesign. It is built for
**design-space evaluation** (ranking, filtering, Pareto trade-offs)
rather than claiming a single "optimal design".
Focusing on user experience, correctness, and speed, it supports off-the-shelf
parallel processing with progress tracking, caching, and reproducible reporting.
...
- Dependency-aware tuning: express argument dependency relationships precisely,
  for example, spending functions and their spending parameters.
